...
function index() {
  ...
  // Tu código aca:
  function.encontrarIndex(elemento){
    int i;
...
function crearClaseEmpleado() {
  ...
  class Empleado {
    ...
    addTarea(tarea, prioridad) {
      ...
      if (prioridad < array.lenght){
        tareas [prioridad] . tarea = tarea;
        tareas [prioridad] . prioridad = prioridad
      }
    }
    ...
    getTareas() {
      ...
      for (i= 0;i < array.lenght; i ++){
        ...
        console.log (tareas [i].prioridad);
      }
    ...
    getTareasPrioritarias(prioridad) {
      ...
      for (i = 0; i < array.lenght; i++){
        ...
        max = tarea[i].prioridad
      }
      console.log("tarea: " + tarea[posmax].tareas)
      console.log("priodidad: " + tarea[posmax].prioridad)
    }
